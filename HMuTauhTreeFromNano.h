...
class HMuTauhTreeFromNano : public HTauTauTreeFromNanoBase {
 public :
  ...
  HMuTauhTreeFromNano(TTree *tree=0, bool doSvFit=false, std::string prefix="HTTMT");
...
HMuTauhTreeFromNano::HMuTauhTreeFromNano(TTree *tree, bool doSvFit, std::string prefix) : HTauTauTreeFromNanoBase(tree, doSvFit, prefix) 
{}

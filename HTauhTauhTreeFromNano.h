...
class HTauhTauhTreeFromNano : public HTauTauTreeFromNanoBase {
 public :
  ...
  HTauhTauhTreeFromNano(TTree *tree=0, bool doSvFit=false, bool correctRecoil=false, std::vector<std::string> lumis = std::vector<std::string>(), std::string prefix="HTTTT");
...
HTauhTauhTreeFromNano::HTauhTauhTreeFromNano(TTree *tree, bool doSvFit, bool correctRecoil, std::vector<std::string> lumis, std::string prefix) : HTauTauTreeFromNanoBase(tree, doSvFit, correctRecoil, lumis, prefix)
{}
